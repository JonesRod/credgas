...
$sql_query = "SELECT * FROM contador_notificacoes_admin WHERE not_novos_produtos = '1'";
            ...
            <?php while ($parceiro = $result->fetch_assoc()): ?>
                ...
                <tr>
                    ...
                    <td data-label="Detalhes">
                        <a href="detalhes_novos_produtos.php?id=<?php echo htmlspecialchars($parceiro['id']); ?>&id_parceiro=<?php echo htmlspecialchars($parceiro['id_parceiro']); ?>&id_produto=<?php echo htmlspecialchars($parceiro['id_produto']); ?>">
                            Ver Detalhes
                        </a>
                    </td>
