...
<body>
    ...
    <div class="form-container">
        <form id="form_crediario" method="POST" action="finalizar_compra_crediario.php">
            ...
            <input type="text" id="bandeiras_aceitas" name="bandeiras_aceitas" style="display: none;"
                value="<?php echo $bandeiras_aceitas; ?>" readonly>

            <hr style="border: 1px solid #ccc; margin: 10px 0;">

            <div id="popup-pix"
                style="<?php if ($tipo_entrada_crediario == 1) {
                    echo 'display: block;';
                } else {
                    echo 'display: none;';
                } ?>">
                ...
                <button type="button" id="btn_continuar" onclick="abrirPopupRestante()"
                    style="display: none;">Continuar</button>
            </div>

            <div id="popup_cartaoCred"
                style="<?php if ($tipo_entrada_crediario == 2) {
                    echo 'display: block;';
                } else {
                    echo 'display: none;';
                } ?>">
                ...
                <div>
                    ...
                    <input id="parcelas_cartaoCred_entrada" name="parcelas_cartaoCred_entrada" type="number" min="1"
                        value="1" onchange="calcularValorParcela()">
                </div>
                <div>
                    <p>Valor da Parcela: R$ <span
                            id="valor_parcela_cartaoCred_entrada"><?php echo $entrada_formatado; ?></span></p>
                </div>
                <button type="button" class="usar-outro-cartao" onclick="abrirPopupNovoCartao()">Usar outro
                    cartão</button>
                <button type="button" id="btn_continuar_cartaoCred" onclick="abrirPopupRestante()"
                    style="display: none;">Continuar</button>
                <br>
            </div>

            <div id="popup_cartaoDeb"
                style="<?php if ($tipo_entrada_crediario == 3) {
                    echo 'display: block;';
                } else {
                    echo 'display: none;';
                } ?>">
                ...
                <button type="button" class="usar-outro-cartao-debito" onclick="abrirPopupNovoCartao()">Usar outro
                    cartão</button>
                <button type="button" id="btn_continuar_cartaoDeb" onclick="abrirPopupRestante()"
                    style="display: none;">Continuar</button>
                <br>
            </div>
            ...
            <div id="detalhes_cartao" style="display: none;">
                ...
                <input type="text" id="valor_parcela_cartao_selecionado" name="valor_parcela_cartao_selecionado"
                    readonly>
                <input type="text" id="parcelas_cartaoCred_entrada_selecionado"
            ...
            <div id="popup_novo_cartao" class="popup-content-cartoes" style="display: none;">
                ...
                <div id="dados_cartao">
                    <div>
                        ...
                        <input type="text" id="tipo_cartao" name="tipo_cartao"
                            value="<?php if ($tipo_entrada_crediario == 2) {
                                echo 'Crédito';
                            } else {
                                echo 'Débito';
                            } ?>"
                    ...
                    <div>
                        ...
                        <input type="text" id="nome_cartao" name="nome_cartao" required
                            value="<?php echo isset($nome_cartao) ? $nome_cartao : ''; ?>">
                    </div>
                    <div>
                        <label for="num_cartao">Número do Cartão:</label>
                        <input type="text" id="num_cartao" name="num_cartao" required
                            oninput="formatarNumeroCartao(this)"
                            value="<?php echo isset($num_cartao) ? $num_cartao : ''; ?>">
                    </div>
                    <div>
                        <label for="validade">Validade:</label>
                        <input type="text" id="validade" name="validade" required oninput="formatarValidadeCartao(this)"
                            value="<?php echo isset($validade) ? $validade : ''; ?>">
                    </div>
                    <div>
                        <label for="cod_seguranca">Código de Segurança:</label>
                        <input type="text" id="cod_seguranca" name="cod_seguranca" required
                            oninput="formatarCodSeguranca(this)"
                            value="<?php echo isset($cod_seguranca) ? $cod_seguranca : ''; ?>">
                    </div>
                    <div
                        style="<?php if ($tipo_entrada_crediario == 2) {
                            echo 'display: block;';
                        ...
                        <input id="parcelas_cartaoCred_entrada_novo" name="parcelas_cartaoCred_entrada_novo"
                            type="number" min="1" value="1" onchange="calcularValorParcelaNovo()">
                    </div>
                    <div
                        style="<?php if ($tipo_entrada_crediario == 2) {
                            echo 'display: block;';
                        ...
                        <p>Valor da Parcela: R$ <span
                                id="valor_parcela_cartaoCred_entrada_novo"><?php echo $entrada_formatado; ?></span></p>
                    </div>
                </div>
                ...
                <select id="parcelas" name="parcelas">
                    ...
                    if ($maior_parcelas > 0):
                        for ($i = 1; $i <= $maior_parcelas; $i++): ?>
                            <option value="<?php echo $i; ?>"><?php echo $i; ?>x <?php echo $i === 1 ? '(sem juros)' : ''; ?>
                            </option>
                        <?php endfor;
                    else: ?>
...
<script>
    ...
    function calcularValorParcelaNovo() {
        valor_parcela_cartaoCred_entrada_novo
        const valorTotal = parseFloat(document.getElementById('entrada').value) || 0;
