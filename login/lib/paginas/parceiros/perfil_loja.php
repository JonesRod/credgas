...
<head>
    ...
    <title>Dados da minha Loja</title>
    <link rel="stylesheet" href="perfil_loja.css">
</head>
<body>
    
    <form id="cadastroEmpresa" action="edita_perfil_loja.php" method="POST">

        <h2>Cadastre-se e comece a vender</h2>

        <a href="parceiro_home.php">← Voltar</a><br>
        ...
        <button type="submit" id="salvar" disabled ="false">Salvar</button>
    </form>
